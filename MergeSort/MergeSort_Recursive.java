...
public class MergeSort_Recursive {
    ...
    static String type = "mr";
    static MainRunner obj = new MainRunner();

    public MergeSort_Recursive(int[] array) throws InterruptedException {
        SIZE = array.length;
    ...
    public static void oneThread(int[] array) throws InterruptedException {
        ...
        MergeSort_Recursive_Thread runner1_1 = new MergeSort_Recursive_Thread(array);
        runner1_1.start();
    ...
    public static void twoThread(int[] array) throws InterruptedException {
        ...
        MergeSort_Recursive_Thread runner1_2 = new MergeSort_Recursive_Thread(subArr1);
        MergeSort_Recursive_Thread runner2_2 = new MergeSort_Recursive_Thread(subArr2);
...
//wait unil both threads are finished
    ...
    public static void fourThread(int[] array) throws InterruptedException {
        ...
        MergeSort_Recursive_Thread runner1_4 = new MergeSort_Recursive_Thread(subArr1);
        MergeSort_Recursive_Thread runner2_4 = new MergeSort_Recursive_Thread(subArr2);
        MergeSort_Recursive_Thread runner3_4 = new MergeSort_Recursive_Thread(subArr3);
        MergeSort_Recursive_Thread runner4_4 = new MergeSort_Recursive_Thread(subArr4);
