...
public class InsertionSort_Recursive {
    ...
    static String type = "ir";
    static MainRunner obj = new MainRunner();
    
    public InsertionSort_Recursive(int[] array) throws InterruptedException
    {
        SIZE = array.length;
    ...
    public static void oneThread(int[] array) throws InterruptedException
    {
        ...
        InsertionSort_Recursive_Thread runner1_1 = new InsertionSort_Recursive_Thread(array);
    ...
    public static void twoThread(int[] array) throws InterruptedException
    {
        ...
        InsertionSort_Recursive_Thread runner1_2 = new InsertionSort_Recursive_Thread(subArr1);
        InsertionSort_Recursive_Thread runner2_2 = new InsertionSort_Recursive_Thread(subArr2);
...
//wait unil both threads are finished
    ...
    public static void fourThread(int[] array) throws InterruptedException
    {
        ...
        InsertionSort_Recursive_Thread runner1_4 = new InsertionSort_Recursive_Thread(subArr1);
        InsertionSort_Recursive_Thread runner2_4 = new InsertionSort_Recursive_Thread(subArr2);
        InsertionSort_Recursive_Thread runner3_4 = new InsertionSort_Recursive_Thread(subArr3);
        InsertionSort_Recursive_Thread runner4_4 = new InsertionSort_Recursive_Thread(subArr4);
