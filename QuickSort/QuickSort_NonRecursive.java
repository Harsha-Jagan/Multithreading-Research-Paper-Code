...
public class QuickSort_NonRecursive {
    public static int SIZE;
    public static int[] sortedArr;
    
    static String type = "qn";
    static MainRunner obj = new MainRunner();
    
    public QuickSort_NonRecursive(int[] array) throws InterruptedException
    {
        SIZE = array.length;
    ...
    public static void oneThread(int[] array) throws InterruptedException
    {
        ...
        QuickSort_NonRecursive_Thread runner1_1 = new QuickSort_NonRecursive_Thread(array);
        runner1_1.start();
    ...
    public static void twoThread(int[] array) throws InterruptedException
    {
        ...
        QuickSort_NonRecursive_Thread runner1_2 = new QuickSort_NonRecursive_Thread(subArr1);
        QuickSort_NonRecursive_Thread runner2_2 = new QuickSort_NonRecursive_Thread(subArr2);
...
//wait unil both threads are finished
    ...
    public static void fourThread(int[] array) throws InterruptedException
    {
        ...
        QuickSort_NonRecursive_Thread runner1_4 = new QuickSort_NonRecursive_Thread(subArr1);
        QuickSort_NonRecursive_Thread runner2_4 = new QuickSort_NonRecursive_Thread(subArr2);
        QuickSort_NonRecursive_Thread runner3_4 = new QuickSort_NonRecursive_Thread(subArr3);
        QuickSort_NonRecursive_Thread runner4_4 = new QuickSort_NonRecursive_Thread(subArr4);
