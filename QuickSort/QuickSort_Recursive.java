...
import static mainrunner.QuickSort.QuickSort_NonRecursive.obj;

public class QuickSort_Recursive {
    public static int SIZE;
    public static int[] sortedArr;
    
    static String type = "qr";
    static MainRunner obj = new MainRunner();
    
    public QuickSort_Recursive(int[] array) throws InterruptedException
    {
        SIZE = array.length;
    ...
    public static void oneThread(int[] array) throws InterruptedException
    {
        ...
        QuickSort_Recursive_Thread runner1_1 = new QuickSort_Recursive_Thread(array, 0, array.length-1);
        runner1_1.start();
    ...
    public static void twoThread(int[] array) throws InterruptedException
    {
        ...
        QuickSort_Recursive_Thread runner1_2 = new QuickSort_Recursive_Thread(subArr1, 0, subArr1.length-1);
        QuickSort_Recursive_Thread runner2_2 = new QuickSort_Recursive_Thread(subArr2, 0, subArr2.length-1);
...
//wait unil both threads are finished
    ...
    public static void fourThread(int[] array) throws InterruptedException
    {
        ...
        QuickSort_Recursive_Thread runner1_4 = new QuickSort_Recursive_Thread(subArr1, 0, subArr1.length-1);
        QuickSort_Recursive_Thread runner2_4 = new QuickSort_Recursive_Thread(subArr2, 0, subArr2.length-1);
        QuickSort_Recursive_Thread runner3_4 = new QuickSort_Recursive_Thread(subArr3, 0, subArr3.length-1);
        QuickSort_Recursive_Thread runner4_4 = new QuickSort_Recursive_Thread(subArr4, 0, subArr4.length-1);
